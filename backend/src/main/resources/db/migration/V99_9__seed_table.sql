insert into users (email, password, email_verified_at, role) values ('andi@gmail.com', '$2a$10$3Zixdrt0Ybxd2aqp/ZzvdOALigZRgjf9x3hkBn.8pm5VDrfTxX5L2', null, 'SUPER_ADMIN');
insert into users (email, password, email_verified_at, role) values ('arum@gmail.com', '$2a$10$3Zixdrt0Ybxd2aqp/ZzvdOALigZRgjf9x3hkBn.8pm5VDrfTxX5L2', null, 'USER');
